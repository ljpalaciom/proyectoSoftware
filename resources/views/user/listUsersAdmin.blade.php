...
<div class="container">
  <div align="left">
    <a type="button" class="btn btn-outline-dark" href="{{ route('user.listByNameAdmin')}}" >{{ __('user.orderByName') }}</a>
    <a type="button" class="btn btn-outline-dark" href="{{ route('user.listUsersAdmin')}}">{{ __('user.orderById') }}</a>
